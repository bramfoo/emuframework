...
INSERT INTO softwarearchive.apps (app_id, name, version, description, creator, release_date, license, language, reference, user_instructions) VALUES('APP-1000', 'FreeDOS Edit','1.0','FreeDOS improved clone of MS-DOS Edit', 'FreeDOS', '2008', 'GNU General Public License, version 2', 'English', 'http://www.freedos.org/software/?prog=edit', FILE_READ('./database/UserInstructions/FreeDOS_Edit_manual.txt', NULL));
INSERT INTO softwarearchive.apps (app_id, name, version, description, creator, release_date, license, language, reference, user_instructions) VALUES('APP-1001', 'Blocek','1.33b','Image viewer for DOS', 'Laaca', '3 November 2007', 'GNU General Public License, version 2', 'English', 'http://www.laaca-mirror.ic.cz/', FILE_READ('./database/UserInstructions/Blocek_manual.txt', NULL));
INSERT INTO softwarearchive.apps (app_id, name, version, description, creator, release_date, license, language, reference, user_instructions) VALUES('APP-1002', 'Xzgv', null, 'Xzgv is a picture viewer for X, with a thumbnail-based file selector. It uses GTK+ and Imlib. Most file formats are supported, and the thumbnails used are compatible with xv, zgv, and the Gimp.', null, null, 'GNU General Public License', 'English', 'http://www.archive.org/details/tucows_51418_xzgv', FILE_READ('./database/UserInstructions/Xzgv_manual.txt', NULL));
INSERT INTO softwarearchive.apps (app_id, name, version, description, creator, release_date, license, language, reference, user_instructions) VALUES('APP-1003', 'Xpdf', null, 'Xpdf is an open source viewer for Portable Document Format (PDF) files. Xpdf is designed to be small and efficient.', 'Derek Noonburg', null,'GNU General Public License (GPL), version 2', 'English', 'http://www.foolabs.com/xpdf/index.html', FILE_READ('./database/UserInstructions/Xpdf_manual.txt', NULL));
INSERT INTO softwarearchive.apps (app_id, name, version, description, creator, release_date, license, language, reference, user_instructions) VALUES('APP-1004', 'Beaver', null, 'Beaver is an Early AdVanced (text) EditoR. ', 'Marc Bevand, Damien Terrier and Emmanuel Turquin, 2008 Tobias Heinzen, Double 12', null, 'GNU General Public License', 'English', 'http://beaver-editor.sourceforge.net/', FILE_READ('./database/UserInstructions/Beaver_manual.txt', NULL));
INSERT INTO softwarearchive.apps (app_id, name, version, description, creator, release_date, license, language, reference, user_instructions) VALUES('APP-1005', 'Firefox', null, 'Mozilla Firefox is a free and open source web browser descended from the Mozilla Application Suite and managed by Mozilla Corporation.', 'Mozilla Corporation', null, 'GNU GPL, GNU LGPL, or Mozilla Public License', 'English', 'http://www.mozilla.com/en-US/firefox', FILE_READ('./database/UserInstructions/Firefox_manual.txt', NULL));
INSERT INTO softwarearchive.apps (app_id, name, version, description, creator, release_date, license, language, reference, user_instructions) VALUES('APP-1006', 'MS Office Viewer', null, null, null, null, 'GNU General Public License (GPL)', 'English', 'http://www.damnsmalllinux.org/applications.html', FILE_READ('./database/UserInstructions/MS_Office_Viewer_manual.txt', NULL));
