...
INSERT INTO emulatorarchive.emulators (emulator_id,name,version,exec_type,exec_name,description,language_id,package_name,package_type,package_version,package) VALUES(4, 'Vice', '2.2', 'ELF', 'x64', 'VICE, the VersatIle Commodore Emulator (Linux)', 'en', 'LinVICE_22Package.zip', 'zip', '1', FILE_READ('./packages/LinVICE_22Package.zip'));
INSERT INTO emulatorarchive.emulators (emulator_id,name,version,exec_type,exec_name,description,language_id,package_name,package_type,package_version,package) VALUES(5, 'Vice', '2.2', 'exe', 'x64.exe', 'VICE, the VersatIle Commodore Emulator (Windows)', 'en', 'WinVICE_22Package.zip', 'zip', '1', FILE_READ('./packages/WinVICE_22Package.zip'));
INSERT INTO emulatorarchive.emulators (emulator_id,name,version,exec_type,exec_name,description,language_id,package_name,package_type,package_version,package) VALUES(6, 'Qemu', '0.13.0', 'ELF', 'qemu', 'Qemu, the generic and open source machine emulator and virtualiser (Linux)', 'en', 'LinQemu_0130Package.zip', 'zip', '1', FILE_READ('./packages/LinQemu_0130Package.zip'));
INSERT INTO emulatorarchive.emulators (emulator_id,name,version,exec_type,exec_name,description,language_id,package_name,package_type,package_version,package) VALUES(7, 'Qemu', '0.9.0', 'exe', 'qemu.exe', 'Qemu, the generic and open source machine emulator and virtualiser (Windows)', 'en', 'WinQemu_090Package.zip', 'zip', '1', FILE_READ('./packages/WinQemu_090Package.zip'));
INSERT INTO emulatorarchive.emulators (emulator_id,name,version,exec_type,exec_name,description,language_id,package_name,package_type,package_version,package) VALUES(8, 'UAE', '0.8.29', 'ELF', 'uae', 'UAE, Amiga emulator for Linux', 'en', 'LinUAE_0829Package.zip', 'zip', '1', FILE_READ('./packages/LinUAE_0829Package.zip'));
INSERT INTO emulatorarchive.emulators (emulator_id,name,version,exec_type,exec_name,description,language_id,package_name,package_type,package_version,package) VALUES(9, 'UAE', '1.6', 'exe', 'winuae.exe', 'UAE, Amiga emulator for Windows', 'en', 'WinUAE_16Package.zip', 'zip', '1', FILE_READ('./packages/WinUAE_16Package.zip'));
INSERT INTO emulatorarchive.emulators (emulator_id,name,version,exec_type,exec_name,description,language_id,package_name,package_type,package_version,package) VALUES(10, 'JavaCPC', '6.7', 'exe', 'JavaCPC.exe', 'JavaCPC, Java Amstrad emulator (Windows)', 'en', 'WinJavaCPC_67.zip', 'zip', '1', FILE_READ('./packages/WinJavaCPC_67Package.zip'));
INSERT INTO emulatorarchive.emulators (emulator_id,name,version,exec_type,exec_name,description,language_id,package_name,package_type,package_version,package) VALUES(11, 'Dioscuri', '0.6.0', 'jar', 'Dioscuri-0.6.0.jar', 'Dioscuri, the modular emulator', 'en', 'dioscuri_060Package.zip', 'zip', '1', FILE_READ('./packages/dioscuri_060Package.zip'));
INSERT INTO emulatorarchive.emulators (emulator_id,name,version,exec_type,exec_name,description,language_id,package_name,package_type,package_version,package) VALUES(12, 'Dioscuri', '0.5.0', 'jar', 'Dioscuri-0.5.0.jar', 'Dioscuri, the modular emulator', 'en', 'dioscuri_050Packagev2.zip', 'zip', '2', FILE_READ('./packages/dioscuri_050Packagev2.zip'));
INSERT INTO emulatorarchive.emulators (emulator_id,name,version,exec_type,exec_name,description,language_id,package_name,package_type,package_version,package) VALUES(13, 'BeebEm', '0.0.13', 'ELF', 'beebem', 'BeebEm, BBC Micro and Master 128 Emulator (Linux)', 'en', 'LinBeebEm_0013Package.zip', 'zip', '1', FILE_READ('./packages/LinBeebEm_0013Package.zip'));
INSERT INTO emulatorarchive.emulators (emulator_id,name,version,exec_type,exec_name,description,language_id,package_name,package_type,package_version,package) VALUES(14, 'BeebEm', '4.13', 'exe', 'beebem.exe', 'BeebEm, BBC Micro and Master 128 Emulator (Windows)', 'en', 'WinBeebEm_413Package.zip', 'zip', '1', FILE_READ('./packages/WinBeebEm_413Package.zip'));
INSERT INTO emulatorarchive.emulators (emulator_id,name,version,exec_type,exec_name,description,language_id,package_name,package_type,package_version,package) VALUES(15, 'Thomson', '1.0', 'exe', 'bnftowin.exe', 'Thomson Emulator (Windows)', 'fr', 'WinThomson_10Package.zip', 'zip', '1', FILE_READ('./packages/WinThomson_10Package.zip'));
